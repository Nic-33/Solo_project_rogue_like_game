...
from .api.user_info_routes import user_info_routes
...
app.register_blueprint(usable_routes, url_prefix='/api/use_inv')
app.register_blueprint(user_info_routes, url_prefix='/api/info')
db.init_app(app)
Migrate(app, db)
